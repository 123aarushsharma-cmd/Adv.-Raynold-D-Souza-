...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* 1. Atmospheric Backlight & Warm Golden Aura */}
      <div 
        className="absolute top-1/2 right-[-8%] sm:right-[-4%] md:right-[3%] lg:right-[6%] -translate-y-1/2 w-[320px] sm:w-[480px] md:w-[640px] lg:w-[840px] h-[320px] sm:h-[480px] md:h-[640px] lg:h-[840px] bg-gradient-to-br from-gold/25 via-forest-light/35 to-transparent rounded-full blur-[90px] sm:blur-[120px] md:blur-[150px] pointer-events-none" 
      />

      {/* 2. Majestic Hero Image Watermark - Restored Exactly as in Reference Image */}
      <div 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full my-auto py-8 sm:py-12 md:py-16">
        <div className="max-w-3xl text-left mx-0">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif text-ivory font-bold tracking-tight leading-[1.12] mb-6 sm:mb-8 text-left"
          >
          ...
          <motion.p
            ...
            style={{ willChange: "transform, opacity", transform: "translateZ(0)" }}
            className="text-base sm:text-lg md:text-xl lg:text-2xl text-ivory/90 font-sans leading-relaxed max-w-2xl font-light text-left"
          >
            {hero.subheadline}
          </motion.p>
        </div>
