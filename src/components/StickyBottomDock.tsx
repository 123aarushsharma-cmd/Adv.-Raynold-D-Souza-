...
export default function StickyBottomDock({ 
  ...
  return (
    <motion.aside 
      ...
      className="fixed bottom-20 sm:bottom-8 right-3 sm:right-6 z-40 flex flex-col items-end gap-2.5 sm:gap-3 select-none pointer-events-auto"
    >
      ...
      >
        ...
        <AnimatePresence>
          {activeCard === "call" && (
            <motion.div 
              key="call-card"
              initial={{ opacity: 0, y: 8, sm: { x: 12, y: 0 }, scale: 0.94 }}
              animate={{ opacity: 1, y: 0, sm: { x: 0, y: 0 }, scale: 1 }}
              exit={{ opacity: 0, y: 6, sm: { x: 8, y: 0 }, scale: 0.95 }}
              ...
              <div className="w-[calc(100vw-2rem)] max-w-[310px] sm:w-80 bg-forest/98 backdrop-blur-2xl border border-gold/40 rounded-xl p-4 shadow-[0_20px_45px_rgba(0,0,0,0.6)] text-ivory relative overflow-hidden ring-1 ring-gold/25">
                ...
                <div className="flex items-start justify-between gap-2.5 mb-2.5">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-gold/15 text-gold flex items-center justify-center shrink-0 border border-gold/30 shadow-inner">
                      <PhoneCall size={16} />
                    </div>
                    <div>
                      ...
                      <h4 className="font-serif text-sm sm:text-base font-bold text-ivory leading-tight">
                        Adv. Reynold D'Souza
                      </h4>
                    </div>
                  </div>
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="w-5 h-5 rounded hover:bg-gold/20 text-ivory/60 hover:text-gold flex items-center justify-center transition-colors cursor-pointer"
                      title="Close"
                      aria-label="Close call card"
                    >
                      <X size={12} />
                    </button>
                  </div>
                ...
                <a 
                  ...
                  className="w-full py-2.5 px-3 mb-2 rounded-lg bg-gold hover:bg-gold-hover text-forest text-center font-sans font-bold text-xs sm:text-sm tracking-wide transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg active:scale-95 group/call"
                  id="sticky-bottom-direct-call"
                >
                  <PhoneCall size={15} className="shrink-0 transition-transform group-hover/call:scale-110" />
        ...
        <motion.a
          ...
          className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-forest text-gold border-2 border-gold/45 hover:border-gold shadow-[0_8px_24px_rgba(0,0,0,0.4)] hover:shadow-[0_0_22px_rgba(201,162,39,0.5)] flex items-center justify-center cursor-pointer transition-colors duration-200 group"
          title="Direct Call Helpline: +91 97405 77775"
          id="sticky-call-btn"
          aria-label="Call Advocate Reynold D'Souza"
        >
          ...
          <PhoneCall size={19} className="transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110" />
          
          {/* Live availability indicator badge */}
          <span className="absolute -top-0.5 -right-0.5 w-3 h-3 rounded-full bg-emerald-400 ring-2 ring-forest shadow-sm" />
        </motion.a>
      </div>
      ...
      >
          ...
          {activeCard === "intake" && (
            ...
            >
              <div className="w-[calc(100vw-2rem)] max-w-[310px] sm:w-80 bg-forest/98 backdrop-blur-2xl border border-gold/40 rounded-xl p-4 shadow-[0_20px_45px_rgba(0,0,0,0.6)] text-ivory relative overflow-hidden ring-1 ring-gold/25">
                ...
                <div className="flex items-start justify-between gap-2.5 mb-2.5">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-gold text-forest flex items-center justify-center shrink-0 shadow-sm">
                      <FileText size={16} />
                    </div>
                    <div>
                      <span className="font-sans text-[10px] uppercase tracking-widest text-gold font-bold block leading-none mb-1">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-3 rounded-lg bg-gold hover:bg-gold-hover text-forest font-sans font-bold text-xs uppercase tracking-wider transition-all duration-200 cursor-pointer flex items-center justify-center gap-1.5 shadow-md hover:shadow-lg active:scale-95 group/btn"
                  id="sticky-bottom-intake-submit"
                >
                  <Sparkles size={14} className="text-forest transition-transform group-hover/btn:rotate-12" />
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.92 }}
          transition={{ type: "spring", stiffness: 420, damping: 22 }}
          className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-gold via-gold-hover to-[#9B7A18] text-forest border-2 border-gold-hover shadow-[0_8px_24px_rgba(201,162,39,0.35)] hover:shadow-[0_0_24px_rgba(201,162,39,0.6)] flex items-center justify-center cursor-pointer transition-colors duration-200 group"
        ...
        >
          ...
          <FileText size={19} className="transition-transform duration-300 group-hover:scale-110" />
          
          {/* Subtle gold badge dot */}
          <span className="absolute -top-0.5 -right-0.5 w-3 h-3 rounded-full bg-forest border-2 border-gold flex items-center justify-center shadow-sm">
